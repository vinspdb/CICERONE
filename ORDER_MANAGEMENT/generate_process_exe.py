...
import pm4py
import sys
from filter_ocel import main_filter
...
if __name__ == '__main__':
    ...
    extractor = OCELProcessExtractor(
        db_path=f"ocel/order_management_{thr}.sqlite",
        output_path=f"ocel/processes_order_management_{thr}.csv",
        config_path="ocel/orders.yaml"
    )
