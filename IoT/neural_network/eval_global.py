...
class SimpleGlobalTextPredictor(nn.Module):
    def __init__(
        ...
        # Ottieni la dimensione dell'encoder
...
if __name__ == "__main__":
    ...
    state_dict = torch.load(f"neural_network/model/global_ok/best_model_{global_encoder_type}_{ocel_name}_{encoder_name}.pt", map_location=device)
